...
7. In WSO2 IS registry created a new object (eg. text) named `spork` in /_system/config and add properties `spork_key_id` (id of private key from Firebase) and `spork_client_id` there.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzM3MTc2NDUsLTE1Mzk2NTE3NV19
-->