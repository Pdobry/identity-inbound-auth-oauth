...
7. In WSO2 IS registry created a new object (eg. text) named `spork` in /_system/config and add properties `spork_key_id` (id ofand `spork_client_id` there.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE1NjkzMDQ5MywtMTUzOTY1MTc1XX0=
-->