...
7. In WSO2 IS registry created a new object (eg. text) named `spork` in /_system/config and add properties `spork_key_id` (id of privand `spork_client_id` there.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4MjE2NTcyMCwtMTUzOTY1MTc1XX0=
-->